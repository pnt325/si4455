...
{
0xc2, 0x0f, 0x31, 0xae, 0x16, 0xa5, 0x8d, 0xa4, 0x0e, 0x48, 0x16, 0x82, 0x30, 0xd5, 0xdd, 0x69, 
0x71, 0x60, 0xdd, 0x00, 0x03, 0x2a, 0x24, 0x8b, 0x80, 0x4f, 0x1f, 0xb4, 0x7a, 0x16, 0x3d, 0x6d, 
0x0f, 0x29, 0xcc, 0xf0, 0x2d, 0x4f, 0x47, 0xb9, 0xf2, 0x4d, 0x62, 0xd2, 0xcf, 0x95, 0xd1, 0x7a, 
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_18 ) = {
	.len=19,
	.data={0x08,0x14,0x00,0x63,0x60,0x32,0xe0,0x37,0x5e,0xa4,0x88,0x53,0x4e,0x6d,0xfb,0x64,0x35,0xbf,0xf7,}
};
...
struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_16_data = {
	.len=11,
	.data={0x45,0x6c,0x70,0x72,0x6f,0x53,0x65,0x6e,0x73,0x6f,0x72,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_11 ) = {
	.len=19,
	.data={0x10,0x0d,0x00,0x0f,0x29,0xcc,0xf0,0x2d,0x4f,0x47,0xb9,0xf2,0x4d,0x62,0xd2,0xcf,0x95,0xd1,0x7a,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_9 ) = {
	.len=19,
	.data={0x08,0x0b,0x00,0x71,0x60,0xdd,0x00,0x03,0x2a,0x24,0x8b,0x80,0x4f,0x1f,0xb4,0x7a,0x16,0x3d,0x6d,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_8 ) = {
	.len=16,
	.data={0xc2,0x0f,0x31,0xae,0x16,0xa5,0x8d,0xa4,0x0e,0x48,0x16,0x82,0x30,0xd5,0xdd,0x69,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x0006,.permissions=0x800,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_2},
    {.uuid=0x0009,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x02,.index=0x00,.clientconfig_index=0x00}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_4},
    {.uuid=0x0007,.permissions=0x801,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_5},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_6},
    {.uuid=0x0008,.permissions=0x803,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_7},
    ...
    {.uuid=0x8001,.permissions=0x802,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_10},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_11},
    {.uuid=0x8002,.permissions=0x800,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_12},
    {.uuid=0x0009,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x04,.clientconfig_index=0x01}},
    ...
    {.uuid=0x0004,.permissions=0x801,.caps=0xffff,.datatype=0x02,.dynamicdata=&bg_gattdb_data_attribute_field_16},
    ...
    {.uuid=0x8004,.permissions=0x802,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_19},
};
